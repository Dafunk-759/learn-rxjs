...
arrowleft.subscribe(_ => {
  // console.log("Arrowleft")
  subject.next(playermoveLeft)
})
arrowright.subscribe(_ => {
  // console.log("Arrowright")
  subject.next(playermoveright)
})
road.subscribe(i => {
  // console.log("interval")
  subject.next(onInterval(i))
})
scoreIncrease.subscribe(_ => {
  // console.log("score increase")
  subject.next(increaseScore)
})
collisions.subscribe(_ => {
  // console.log("collisions")
  subject.next(decreasePlayerLives)
})
speedUp.subscribe(_ => {
  // console.log("speedUp")
  subject.next(decreaseDuration)
})
needLevelUp.subscribe(_ => {
  // console.log("need level up")
